...
export default function Home() {
  ...
  async function getInfo(e) {
    ...
    try {
      ...
      console.log('Page Data:', response.data.data); // Access data correctly
      setIndividualpage(response.data.data); // Set the relevant data in state
    } catch (error) {
